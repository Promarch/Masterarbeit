...
def main() -> None:
    ...
    filePath = "franka_fr3/scene_copy_robot_presentation.xml"
    ...
    quat_start_anim = np.array([0, 0.7071068, 0.7071068, 0])
    quat_d_anim = np.array([0.2705981, 0.6532815, 0.6532815, 0.2705981]) # -45°
    quat_d_anim = np.array([0.092296, 0.7010574, 0.7010574, 0.092296]) # -10°
    t_anim = 3
    # quat_d = quat_init
    ...
    with mujoco.viewer.launch_passive(
        ...
        while viewer.is_running(): # and time.time()-t_init<6
            ...
            alpha_anim = (1-np.cos(np.pi*time_current/t_anim))/2
            ...
            quat_what = quat_start_anim + (quat_d_anim - quat_start_anim) * alpha_anim
            mujoco.mju_mulQuat(error_quat, quat_what, site_quat_conj)
